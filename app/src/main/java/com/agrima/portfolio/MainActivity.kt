...
class MainActivity : AppCompatActivity() {
    ...
    fun Github(view: View) {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/sassy-bugs"))
        startActivity(intent)
    }
    fun GMail(view: View) {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://mail.google.com/mail/u/?authuser=guptaagrima200@gmail.com"))
        startActivity(intent)
    }
